...
The [macOS Target section](https://docs.prowl.tools/macos-target) is the direct docs entry for permissions and selector discovery (`prowl analyze`) when you're ready to point a hunt at a native app.
