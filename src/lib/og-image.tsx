 ...
 * and the prowl.tools domain — legible at thumbnail size. Other routes can
 * reuse this via the `opengraph-image` / `twitter-image` file conventions
 * with their own eyebrow + headline.
 */
